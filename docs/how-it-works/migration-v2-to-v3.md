...
- `docs/how-it-works/projected-sa.md` — projected-SA Vault auth deep dive
- `docs/how-it-works/nri-mode.md` — NRI plugin deep dive
- `docs/monitoring/prometheus.md` — full metric reference (v3.0 names)
- `docs/monitoring/alertmanager.md` — example alert rules (v3.0 names)
