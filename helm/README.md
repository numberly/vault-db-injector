...
| vaultDbInjector.injector.image.tag | string | `"3.1.0"` | Injector container image tag. |
...
| vaultDbInjector.renewer.image.tag | string | `"3.1.0"` | Renewer container image tag. |
...
| vaultDbInjector.revoker.image.tag | string | `"3.1.0"` | Revoker container image tag. |
