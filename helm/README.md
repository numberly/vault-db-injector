...
![Version: 3.2.5](https://img.shields.io/badge/Version-3.2.5-informational?style=flat-square) ![AppVersion: 3.2.5](https://img.shields.io/badge/AppVersion-3.2.5-informational?style=flat-square)
...
| vaultDbInjector.injector.image.tag | string | `"3.2.5"` | Injector container image tag. |
...
| vaultDbInjector.renewer.image.tag | string | `"3.2.5"` | Renewer container image tag. |
...
| vaultDbInjector.revoker.image.tag | string | `"3.2.5"` | Revoker container image tag. |
